...
type State struct {
	...
	potentialAttackOnDefenderWinsGames          map[common.Hash]*validator.WithdrawalProvenExtensionEvent
	...
	potentialAttackOnInProgressGames         map[common.Hash]*validator.WithdrawalProvenExtensionEvent
...
// 	ret := State{
// 		potentialAttackOnDefenderWinsGames:          make(map[common.Hash]*validator.WithdrawalProvenExtensionEvent),
...
// 		potentialAttackOnInProgressGames:         make(map[common.Hash]*validator.WithdrawalProvenExtensionEvent),
