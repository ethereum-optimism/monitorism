...
// StateRootPeriodSeconds is a free data retrieval call binding the contract method 0xcdc65a8b.
//
// Solidity: function stateRootPeriodSeconds(bytes32 _stateRoot) view returns(uint256)
func (_L2OutputOracle *L2OutputOracleCaller) StateRootPeriodSeconds(opts *bind.CallOpts, _stateRoot [32]byte) (*big.Int, error) {
	var out []interface{}
	err := _L2OutputOracle.contract.Call(opts, &out, "stateRootPeriodSeconds", _stateRoot)
...
//
// Solidity: function stateRootPeriodSeconds(bytes32 _stateRoot) view returns(uint256)
func (_L2OutputOracle *L2OutputOracleSession) StateRootPeriodSeconds(_stateRoot [32]byte) (*big.Int, error) {
	return _L2OutputOracle.Contract.StateRootPeriodSeconds(&_L2OutputOracle.CallOpts, _stateRoot)
}

// StateRootPeriodSeconds is a free data retrieval call binding the contract method 0xcdc65a8b.
//
// Solidity: function stateRootPeriodSeconds(bytes32 _stateRoot) view returns(uint256)
func (_L2OutputOracle *L2OutputOracleCallerSession) StateRootPeriodSeconds(_stateRoot [32]byte) (*big.Int, error) {
	return _L2OutputOracle.Contract.StateRootPeriodSeconds(&_L2OutputOracle.CallOpts, _stateRoot)
}
